...
export default function Checkout() {
  ...
  const formHandler = async (e) => {
    ...
    const order = (
      await axios.post('/orders', {
        ...
        productsArray: cartItems.items.map((item) => {
  ...
  const startPayment = async () => {
    ...
    if (paymentDetails.type == 'crypto') {
      ...
      stripeButton.current.children[0].click();
    }
  };
                ...
                <li className="list-group-item p-4">
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        customerDetailsHandler(e.target.value, 'email')
                      }
                    />
                    <div className="invalid-feedback">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-3 mb-3">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          customerDetailsHandler(e.target.value, 'zip')
                        }
                      />
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-check mb-3">
                        <input
                          ...
                          value="stripe"
                          checked={paymentDetails.type == 'stripe'}
                          onChange={(e) =>
                            paymentDetailsHandler(e.target.value, 'type')
                          }
                        />
                        <label
                      ...
                      <div className="d-grid">
                        <button className="btn btn-block btn-dark" disabled>
                          Card
                        </button>
                      </div>
                    </div>
                    <div className="col-md-6 mb-3">
                      <div className="form-check mb-3">
                        <input
                          ...
                          id="flexRadioDefault1"
                          value="crypto"
                          checked={paymentDetails.type == 'crypto'}
                          onChange={(e) =>
                            paymentDetailsHandler(e.target.value, 'type')
                          }
                        />
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          paymentDetailsHandler(e.target.value, 'currency')
                        }
                      >
